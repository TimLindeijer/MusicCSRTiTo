...
export default function useSocketConnection(
  ...
  path: string = "/socket.io" // Assuming this is the default path
) {
  ...
  useEffect(() => {
    // Specify WebSocket transport only and ensure the path is consistent with your backend
    const newSocket = io(url, { path: path, transports: ['websocket'] });
    setSocket(newSocket);
